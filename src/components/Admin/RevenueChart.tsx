...
const RevenueChart = ({ className = "" }: RevenueChartProps) => {
  ...
  // Mock data cho các khoảng thời gian
  const data7Days = [
    { date: "T2", revenue: 4200000, orders: 12 },
    { date: "T3", revenue: 5800000, orders: 18 },
    { date: "T4", revenue: 4500000, orders: 15 },
    { date: "T5", revenue: 6200000, orders: 22 },
    { date: "T6", revenue: 7100000, orders: 25 },
    { date: "T7", revenue: 8500000, orders: 30 },
    { date: "CN", revenue: 6800000, orders: 24 },
  ]

  const data30Days = [
    { date: "Tuần 1", revenue: 18500000, orders: 65 },
    { date: "Tuần 2", revenue: 22300000, orders: 78 },
    { date: "Tuần 3", revenue: 19800000, orders: 70 },
    { date: "Tuần 4", revenue: 25400000, orders: 89 },
  ]

  const data90Days = [
    { date: "Tháng 1", revenue: 45600000, orders: 189 },
    { date: "Tháng 2", revenue: 52800000, orders: 215 },
    { date: "Tháng 3", revenue: 48900000, orders: 198 },
  ]
      ...
      <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-200">
        <div className="text-center">
          ...
          <p className="text-lg font-bold text-[var(--color-main)]">
            {formatCurrency(
              getChartData().reduce((sum, item) => sum + item.revenue, 0)
            )}
          </p>
        </div>
        <div className="text-center">
          ...
          <p className="text-lg font-bold text-blue-600">
            {getChartData().reduce((sum, item) => sum + item.orders, 0)}
          </p>
        </div>
      </div>
    </div>
